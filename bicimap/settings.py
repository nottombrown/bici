# Django settings for bicimap project.

DEBUG = True
TEMPLATE_DEBUG = DEBUG

DOMAIN = 'http://mobility-server.media.mit.edu'
ROOT_DIR = '/home/tombrown/bici/'
...
ADMIN_MEDIA_PREFIX = DOMAIN + '/media/adminmedia/'
